...
async function addRole() {
    try {
        ...
        await pool.query(
            'INSERT INTO role (title, salary, department_id) VALUES ($1, $2, $3)',  // Usando 'title' para coincidir con la base de datos
...
async function addEmployee() {
    try {
        ...
        await pool.query(
            ...
            [response.first_name, response.last_name, response.employee_role, response.employee_manager]
        );
